...
if(isset($_POST['update_item'])) // Check form submit or not
{
	$SN=$_POST['item_sn'];
...
$sql1 ="SELECT * from items where item_sn='$SN' ";
$sql2="UPDATE items SET item_name = '$itemName',item_price= '$itemPrice',item_category='$itemCat', item_amount='$itemAmount',supplier_id='$itemSuppID' WHERE item_sn = '$SN'";
...
if (mysqli_query($conn, $sql2)){
    ...
    $message ="You updated the item successfully";
} 
}
else 
{
	$message ="Incorrect Item SN/ Supplier ID";
}
}
mysqli_close($conn);
		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
					...
					<span class="login100-form-title p-b-32">
						...
						<p> &nbsp; </p> 
						<p style="color:grey"> * Item SN field cannot be updated </p> 
					</span>
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Supplier ID is required">
					 ...
					 <input type="submit" value="Update" class="login100-form-btn" name="update_item" />
				</form> 
			</div>
		</div>
	</div>
