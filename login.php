...
$sql="SELECT ID FROM staff WHERE password='$upassword'";
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" action="<?php $_SERVER['PHP_SELF']?>" method="post">
					...
					<div class="container-login100-form-btn" style="margin-top:15px;">
						<input type="submit" value="Login" class="login100-form-btn" name="signin" />
